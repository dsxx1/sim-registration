...
- Антиспам защита: 5 **разных** номеров в час с одного IP, блокировка на 1 час
  (повтор того же номера попытку не расходует; остаток показывается 5→1)
...
- Валидация ФИО: ровно 3 слова, каждое от 2 букв (без сокращений и инициалов)
...
2. **Антиспам**: считаются РАЗНЫЕ номера с одного IP (до 5 в час). Повторная
...
4. **Ввод ФИО**: валидация (ровно 3 слова, каждое от 2 букв, только буквы и дефис)
